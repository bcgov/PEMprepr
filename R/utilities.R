...
####--- recursive calling of SAGA modules & warn if modules generate artifacts ---####
#--- moddir and artifacts are internal data in the data/ subdirectory ---#
recursive_layers_call <- function(layers, moddir = PEMprepr::moddir, artifact = PEMprepr::artifacts){
